          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                 Advanced Machine Learning & Statistical Analysis
              </h1>
              
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Master advanced machine learning algorithms, statistical modeling, and predictive analytics 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our advanced curriculum covers sophisticated machine learning techniques, 
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              By the end of this course, you'll have mastered advanced data science techniques 
              and be ready to tackle complex analytical challenges.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Code,
                title: "Advanced ML",
                description: "Master sophisticated machine learning algorithms and techniques."
              },
              {
                icon: BarChart3,
                title: "Statistical Modeling",
                description: "Build robust statistical models for complex data analysis."
              },
              {
                icon: Database,
                title: "Feature Engineering",
                description: "Create and optimize features for better model performance."
              },
              {
                icon: Target,
                title: "Model Evaluation",
                description: "Evaluate and optimize models using advanced techniques."
              },
              {
                icon: TrendingUp,
                title: "Big Data",
              ...
              },
              {
                ...
                description: "Apply advanced techniques to real-world problems."
              }
            ].map((outcome, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Advanced data science skills are in high demand across industries. 
            ...
            {[
              {
                ...
                salary: "₹12-25 LPA",
                description: "Lead complex data science projects and teams"
              },
              {
                title: "ML Engineer",
                salary: "₹10-20 LPA",
              ...
              },
              {
                ...
                salary: "₹15-30 LPA",
                description: "Conduct advanced research in AI/ML"
              },
              {
                title: "Data Science Consultant",
                salary: "₹8-18 LPA",
                description: "Provide expert data science solutions"
              }
            ].map((career, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Master the advanced tools and technologies used in modern data science.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Ready to Start Your Advanced Data Science Journey?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join thousands of successful data scientists who have transformed their careers with our comprehensive training program.
            </p>
            <motion.button
              onClick={() => setShowEnrollmentModal(true)}
...
export default DataScienceLevel2; 