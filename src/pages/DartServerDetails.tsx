          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-blue-600 font-semibold">Dart Server Development</span>
              </div>
              
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                Master Dart Server Development
              </h1>
              
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                Build high-performance server applications with Dart using Aqueduct and Shelf frameworks. Create robust APIs and web services.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master Dart server development from fundamentals to advanced concepts with hands-on projects.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Master Dart programming language fundamentals for server development.",
                topics: ["Dart Syntax", "Async Programming", "Isolates", "Error Handling", "Dart VM"],
                icon: Code,
                color: "blue"
              },
              {
                title: "Aqueduct Framework",
                description: "Learn Aqueduct framework for building robust web applications and APIs.",
                topics: ["Aqueduct Setup", "Resource Controllers", "Database Integration", "Authentication", "Authorization"],
                icon: Package,
                color: "blue"
              },
              {
                title: "Shelf Framework",
                description: "Master Shelf framework for lightweight web server development.",
                topics: ["Shelf Pipeline", "Middleware Development", "Static File Serving", "WebSocket Support", "Routing"],
                icon: Zap,
                color: "blue"
              },
              {
                title: "Deployment & DevOps",
                description: "Deploy Dart server applications and implement DevOps practices.",
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              By the end of this course, you'll be able to build high-performance server applications with Dart.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              "Build high-performance server applications using Dart and Aqueduct/Shelf",
              "Master Dart programming language fundamentals and async programming",
              "Create RESTful APIs and web services with Dart frameworks",
              "Implement authentication and authorization in Dart applications",
              "Deploy Dart server applications to cloud platforms",
              "Work with Dart ecosystem tools and best practices"
            ].map((outcome, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Dart server development skills open doors to exciting career opportunities in backend development.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master the essential tools and technologies in the Dart server development ecosystem.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                name: "Aqueduct Framework",
                description: "Full-featured web framework for Dart",
                icon: Package,
                color: "purple"
              },
              {
                name: "Shelf Framework",
                description: "Lightweight web server framework",
                icon: Server,
                color: "indigo"
              },
              {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-gray-900">Enroll in Dart Server Course</h3>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Ready to Start Your Dart Server Development Journey?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join thousands of successful developers who have transformed their careers with our comprehensive Dart Server training program.
            </p>
            <motion.button
              onClick={() => setShowEnrollmentModal(true)}
...
export default DartServerDetails;