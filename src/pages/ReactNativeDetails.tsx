          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-blue-600 font-semibold">React Native Development</span>
        </div>
              ...
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                Build native mobile applications with React Native. Master cross-platform development using JavaScript and React for iOS and Android.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master React Native from fundamentals to advanced concepts with hands-on projects and real-world applications.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Master the core concepts of React Native including components, navigation, and platform APIs.",
                topics: ["Components & JSX", "Navigation", "Platform APIs", "State Management", "Styling"],
                icon: Code,
                color: "blue"
              },
              {
                title: "Advanced React Native",
                description: "Learn advanced React Native techniques for complex applications and performance optimization.",
                topics: ["Redux & State Management", "Native Modules", "Performance Optimization", "Testing", "Debugging"],
                icon: Zap,
                color: "blue"
              },
              {
                title: "Platform Integration",
                description: "Integrate with native iOS and Android features and third-party libraries.",
                topics: ["Native Modules", "Platform-Specific Code", "Third-Party Libraries", "Device APIs", "Push Notifications"],
                icon: Layers,
                color: "blue"
              },
              {
                title: "Deployment & Publishing",
                description: "Deploy and publish your React Native applications to app stores and production.",
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              By the end of this course, you'll be able to build professional mobile applications with React Native.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              "Master React Native components and navigation patterns",
              "Integrate with native platform features and APIs",
              "Implement advanced state management and performance optimization",
              "Deploy applications to app stores and production",
              "Work with React Native ecosystem tools and libraries"
            ].map((outcome, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              React Native skills open doors to exciting career opportunities in mobile development.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master the essential tools and technologies in the React Native ecosystem.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                name: "Redux",
                description: "State management library for React Native",
                icon: Database,
                color: "indigo"
              },
              {
              ...
              {
                name: "Flipper",
                description: "Debugging platform for React Native",
                icon: Shield,
                color: "green"
              }
            ].map((tool, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Ready to Start Your React Native Development Journey?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join thousands of successful developers who have transformed their careers with our comprehensive React Native training program.
            </p>
            <motion.button
              onClick={() => setShowEnrollmentModal(true)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-gray-900">Enroll in React Native Course</h3>
                <button
...
export default ReactNativeDetails; 