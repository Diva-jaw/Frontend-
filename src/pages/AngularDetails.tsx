          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                Build enterprise-ready web applications with Angular. Master components, services, routing, and advanced patterns for scalable frontend development.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master Angular from fundamentals to advanced concepts with hands-on projects and enterprise applications.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Master the core concepts of Angular including components, templates, and data binding.",
                topics: ["Components & Templates", "Directives", "Data Binding", "Services & Dependency Injection", "Modules"],
                icon: Code,
                color: "blue"
              },
              {
                title: "Routing & Forms",
                description: "Implement navigation and user input handling in Angular applications.",
                topics: ["Angular Router", "Reactive Forms", "Template-driven Forms", "Form Validation", "Route Guards"],
                icon: Globe,
                color: "blue"
              },
              {
                title: "State Management & HTTP",
                description: "Manage application state and interact with APIs using Angular services.",
                topics: ["RxJS & Observables", "NgRx Store", "HTTPClient", "API Integration", "Error Handling"],
                icon: Database,
                color: "blue"
              },
              {
                title: "Testing & Deployment",
                description: "Test and deploy Angular applications with industry best practices.",
                topics: ["Unit Testing", "End-to-End Testing", "Deployment", "Performance Optimization", "CI/CD"],
                icon: Shield,
                color: "blue"
              }
            ].map((module, index) => (
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              By the end of this course, you'll be able to build enterprise-grade Angular applications with confidence.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              "Build scalable, maintainable Angular applications",
              "Master Angular CLI and project structure",
              "Implement routing, forms, and state management",
              "Integrate APIs and deploy production applications",
              "Write comprehensive tests for Angular applications",
              "Work with Angular ecosystem tools and libraries"
            ].map((outcome, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Angular skills open doors to exciting career opportunities in enterprise development.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master the essential tools and technologies in the Angular ecosystem.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                name: "Angular CLI",
                description: "Powerful command-line interface for Angular development",
                icon: Package,
                color: "blue"
              },
              {
                name: "RxJS",
                description: "Reactive programming library for managing async data",
                icon: Zap,
                color: "purple"
              },
              {
                name: "NgRx",
                description: "State management inspired by Redux for Angular apps",
                icon: Database,
                color: "indigo"
              },
              {
                name: "Angular Material",
                description: "UI component library for beautiful Angular apps",
                icon: Palette,
                color: "pink"
              },
              {
              ...
              {
                name: "Jasmine & Karma",
                description: "Testing framework for Angular applications",
                icon: Shield,
                color: "green"
              }
            ].map((tool, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join thousands of successful developers who have transformed their careers with our comprehensive Angular training program.
            </p>
            <motion.button
              onClick={() => setShowEnrollmentModal(true)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-gray-900">Enroll in Angular Course</h3>
                <button
