          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-blue-600 font-semibold">Go with GIN Framework</span>
              </div>
              
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                Master Go GIN Development
              </h1>
              
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                Build high-performance web applications with Go and GIN framework. Master concurrent programming and microservices architecture.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master Go programming and GIN framework from fundamentals to advanced concepts with hands-on projects.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Master Go programming language fundamentals and concurrent programming.",
                topics: ["Go Syntax", "Goroutines & Channels", "Interfaces", "Error Handling", "Concurrency Patterns"],
                icon: Code,
                color: "blue"
              },
              {
                title: "GIN Framework",
                description: "Learn GIN framework for building high-performance web applications.",
                topics: ["GIN Router", "Middleware", "Request/Response", "Validation", "Authentication"],
                icon: Package,
                color: "blue"
              },
              {
                title: "Advanced Go",
                description: "Master advanced Go concepts for complex applications.",
                topics: ["Microservices", "Testing", "Performance Optimization", "Dependency Injection", "Error Handling"],
                icon: Zap,
                color: "blue"
              },
              {
                title: "Deployment & DevOps",
                description: "Deploy Go applications and implement DevOps practices.",
                topics: ["Docker & Containers", "Kubernetes", "CI/CD Pipelines", "Monitoring", "Cloud Deployment"],
                icon: Cloud,
                color: "blue"
              }
            ].map((module, index) => (
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              By the end of this course, you'll be able to build high-performance applications with Go and GIN.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              "Build high-performance web applications using Go and GIN framework",
              "Master Go programming language fundamentals and concurrent programming",
              "Create microservices architecture with Go",
              "Implement authentication and authorization in Go applications",
              "Deploy Go applications to cloud platforms",
              "Work with Go ecosystem tools and best practices"
            ].map((outcome, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Go programming skills open doors to exciting career opportunities in backend development.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master the essential tools and technologies in the Go development ecosystem.
            </p>
          </motion.div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-gray-900">Enroll in Go GIN Course</h3>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Ready to Start Your Go & Gin Development Journey?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join thousands of successful developers who have transformed their careers with our comprehensive Go & Gin training program.
            </p>
            <motion.button
              onClick={() => setShowEnrollmentModal(true)}
