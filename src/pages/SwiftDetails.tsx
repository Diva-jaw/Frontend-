          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-blue-600 font-semibold">Swift Development</span>
        </div>
              
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                Master Swift Development
              </h1>
              
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                Build native iOS applications with Swift. Master Apple's programming language for creating powerful, efficient, and beautiful mobile applications.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master Swift from fundamentals to advanced concepts with hands-on projects and real-world iOS applications.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Master the core concepts of Swift including syntax, data types, and control flow.",
                topics: ["Swift Syntax", "Data Types & Variables", "Control Flow", "Functions & Closures", "Optionals"],
                icon: Code,
                color: "blue"
              },
              {
                title: "iOS Development",
                description: "Learn iOS development with UIKit and SwiftUI for modern app interfaces.",
                topics: ["UIKit Framework", "SwiftUI", "View Controllers", "Auto Layout", "User Interface Design"],
                icon: Palette,
                color: "blue"
              },
              {
                title: "Advanced Swift",
                description: "Master advanced Swift concepts for complex iOS applications.",
                topics: ["Protocols & Extensions", "Generics", "Error Handling", "Memory Management", "Concurrency"],
                icon: Zap,
                color: "blue"
              },
              {
                title: "App Store Deployment",
                description: "Deploy and publish your iOS applications to the App Store.",
                topics: ["App Store Connect", "App Signing", "TestFlight", "App Review Process", "Release Management"],
                icon: Cloud,
                color: "blue"
              }
            ].map((module, index) => (
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              By the end of this course, you'll be able to build professional iOS applications with Swift.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              "Build native iOS applications using Swift and UIKit/SwiftUI",
              "Master Swift programming language fundamentals and advanced concepts",
              "Create beautiful and responsive user interfaces for iOS",
              "Implement data persistence and networking in iOS apps",
              "Deploy applications to the App Store and manage releases",
              "Work with iOS development tools and Apple ecosystem"
            ].map((outcome, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Swift skills open doors to exciting career opportunities in iOS development.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Master the essential tools and technologies in the Swift and iOS development ecosystem.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                name: "Xcode",
                description: "Integrated development environment for iOS development",
                icon: Package,
                color: "blue"
              },
              {
                name: "SwiftUI",
                description: "Modern declarative UI framework for iOS apps",
                icon: Palette,
                color: "purple"
              },
              {
                name: "UIKit",
                description: "Traditional UI framework for iOS development",
                icon: Layers,
                color: "indigo"
              },
              {
                name: "Core Data",
                description: "Data persistence framework for iOS applications",
                icon: Database,
                color: "pink"
              },
              {
              ...
              {
                name: "TestFlight",
                description: "Beta testing platform for iOS applications",
                icon: Shield,
                color: "green"
              }
            ].map((tool, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Ready to Start Your Swift Development Journey?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join thousands of successful developers who have transformed their careers with our comprehensive Swift training program.
            </p>
            <motion.button
              onClick={() => setShowEnrollmentModal(true)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-gray-900">Enroll in Swift Course</h3>
                <button
